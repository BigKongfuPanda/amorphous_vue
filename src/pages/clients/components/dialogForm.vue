<template>
  <el-dialog :title="dialogData.formType === 'create' ? '新增客户' : '修改客户'" 
    ...
    submitForm() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          const { method, url } = this.dialogData.formType === 'create' ? { method: 'post', url: urlmap.addClients } : { method: 'put', url: urlmap.updateClients } ;
