<template>
  <el-dialog :title="dialogData.formType === 'create' ? '新增外观' : '修改外观'" 
    ...
    submitForm() {
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          const { method, url } = this.dialogData.formType === 'create' ? { method: 'post', url: urlmap.addAppearenceLevel } : { method: 'put', url: urlmap.updateAppearenceLevel } ;
