      ...
      >
        <el-table-column type="expand" label="展开" width="50px">
          <template slot-scope="props">
            <!-- 副表 -->
            <el-table :data="props.row.record" stripe border style="width:100%">
              <el-table-column
                label="开包"
                type="index"
                width="50px"
              ...
              ></el-table-column>
              <el-table-column
                prop="treatCoolRoller"
                label="车修铜辊"
                align="center"
                width="80px"
              ></el-table-column>
              <el-table-column
                prop="coolRollerThickness"
                label="铜套厚度"
                align="center"
                width="80px"
              ></el-table-column>
              <el-table-column
                prop="ReceiveMeltTime"
                label="接钢时间"
                align="center"
                width="80px"
              ></el-table-column>
              <el-table-column
                prop="tundishTemperatureWithoutMelt"
                label="接钢前包温/℃"
                align="center"
                width="120px"
              ></el-table-column>
              <el-table-column
                prop="tundishTemperatureWithMelt"
                label="接钢后包温/℃"
                align="center"
                width="120px"
              ></el-table-column>
              <el-table-column
                prop="installNozzleTime"
                label="装杯时间"
                align="center"
                width="80px"
              ></el-table-column>
              ...
              ></el-table-column>
              <el-table-column
                prop="tundishTemperatureCasting"
                label="开包温度/℃"
                align="center"
                width="100px"
              ></el-table-column>
              <el-table-column
                prop="coolRollerTemperatureBeforeCast"
                label="喷带前水温/℃"
                align="center"
                width="120px"
              ></el-table-column>
              <el-table-column
                prop="coolRollerTemperatureAfterCast"
                label="喷带后水温/℃"
                align="center"
                width="120px"
              ></el-table-column>
        ...
        >
          <template slot-scope="scope">
            <span :class="scope.row.castTimes > 1 ? 'text_danger' : ''">{{
              scope.row.castTimes
            }}</span>
          </template>
        </el-table-column>
  ...
  methods: {
    ...
    del(row) {
      ...
      this.$confirm(`删除后数据无法恢复，确定删除 ${furnace} 吗？`, "提示", {
        ...
        .then(() => {
          this.$http("delete", urlmap.delCast, { _id })
            .then(data => {
              this.getTableData();
            })
            .catch(error => {
