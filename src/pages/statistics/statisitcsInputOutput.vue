  ...
  <div>
    ...
    <div class="main_bd">
      ...
      >
        ...
        ></el-table-column>
        <el-table-column
          prop="unqualifiedNetWeight"
          label="不合格净重(kg)"
          align="center"
          width="80px"
        ></el-table-column>
        <el-table-column
          prop="shouldStoredWeight"
          label="理论入库净重(kg)"
          align="center"
          width="80px"
        ></el-table-column>
        ...
        ></el-table-column>
        <el-table-column
          prop="lowStandardRibbonWeight"
          label="低端带材(kg)"
          align="center"
          width="110px"
        ></el-table-column>
        <el-table-column
          prop="actualUnqualifiedNetWeight"
          label="实际不合格带材(kg)"
          align="center"
          width="110px"
        ></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getTableData(params = {}) {
      ...
      this.loading = true;
      this.$http("get", urlmap.queryStatisticsInputOuput, params)
        .then(data => {
